...
import HeroImage from '../assets/sound.jpg'
  ...
  return (
    <div className='bg-black text-white text-center py-16'>
      ...
      <h1 className='text-4xl font-bold'>
        I'm {" "}
        <span className='text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-orange-500'>Soundhar S</span><br />
      ...
      <div className='mt-8 space-x-4'>
        <button
          className='bg-gradient-to-r from-blue-400 to-orange-500 text-white
